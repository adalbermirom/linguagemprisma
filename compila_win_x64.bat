@echo off
@echo
set PATH=%PATH%;C:\ArquivosDeProgramasBETO\mingw64\bin\;
@cls
@echo  ....................................................................
@echo  :                 Compilar Prisma em Windows x86_64(64bits)        :
@echo  ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
@echo  ::  PARA SAIR CLIQUE NO X DA JANELA OU ENTER PARA COMPILAR PRISMA ::
@echo  ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
@PAUSE

@echo criando diretorios obj e bin se ainda nao existem
@mkdir obj
@mkdir bin

@REM SE NECESSÁRIO PODE PASSAR O CAMINHO COMPLETO DOS EXECUTÁVEIS ABAIXO:
@SET COMPILADOR=C:\ArquivosDeProgramasBETO\mingw64\bin\gcc.exe
@SET WINDRES=C:\ArquivosDeProgramasBETO\mingw64\bin\windres.exe
@SET AR=C:\ArquivosDeProgramasBETO\mingw64\bin\ar.exe
@SET RANLIB=C:\ArquivosDeProgramasBETO\mingw64\bin\ranlib
@SET PARAMS=-O2 -Wall
@SET DEF=-DPRISMA_COMPAT_ALL
@SET PRISMA_PATH=src\\
@SET BIN_PATH=bin64\\
@SET OBJ_PATH=prisma\\
