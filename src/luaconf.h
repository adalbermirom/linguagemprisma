...
#define luai_numband(L,a,b)	((lua_Integer)(a)&(lua_Integer)(b)) /* & (and) beto bit modification*/




#define BITSMASK   ((int)(sizeof(lua_Integer) * CHAR_BIT - 1))
/* Shifts: negativos viram 0, grandes demais são mascarados */
/*  << (left shift) beto bit modification*/
#define luai_numbshl(L,a,b)   (((b) < 0) ? 0 : \
                               ((lua_Integer)(a) << ((lua_Integer)(b) & BITSMASK)))

/*  >> (right shift) beto bit modification*/
#define luai_numbshr(L,a,b)   (((b) < 0) ? 0 : \
                               ((lua_Integer)(a) >> ((lua_Integer)(b) & BITSMASK)))




#define luai_numbor(L,a,b)	((lua_Integer)(a)|(lua_Integer)(b)) /*   | (bitwise OR)  beto bit modification*/
#define luai_numbxor(L,a,b)	((lua_Integer)(a)^(lua_Integer)(b)) /*   ^ (bitwise OR)  beto bit modification*/
#define luai_numunbnot(L,a)	(~(lua_Integer)(a)) /*   ~ (bitwise)  beto bit modification*/
...
#define LUA_INTEGER	long int /*Beto modification original acima*/
/*
